...
- [`experiments/07-wfra2-precursor/README.md`](../experiments/07-wfra2-precursor/README.md) — **прекурсор WFRA-2.0**: композитный лосс + warm-up (ещё не полный RFP v1 без backward)
